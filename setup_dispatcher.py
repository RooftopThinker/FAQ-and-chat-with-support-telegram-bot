from handlers import approve_review, start, get_bonus, problems, cancellation, contacts, faq
...
async def setup_dispatcher(dispatcher: Dispatcher):
    dispatcher.include_routers(start.router, approve_review.router, export_to_excel.router,
                               ...
                               respond_to_appeal.router, show_menu.router, mailing.router, stats.router)
